...
function singular_register_scripts():void{
    ...
    wp_enqueue_script( 'singular_jquery', THEME_DIRECTORY_URI.'/assets/js/jquery.min.js', array(), '1.0.0'  );
    wp_enqueue_script( 'singular_bootstrap', THEME_DIRECTORY_URI.'/assets/js/bootstrap.min.js', array('singular_jquery'), $version );
    wp_enqueue_script( 'singular_html_five_min', THEME_DIRECTORY_URI.'/assets/js/html5.min.js', array(), $version );
    wp_enqueue_script( 'singular_placeholders', THEME_DIRECTORY_URI.'/assets/js/placeholders.min.js', array(), $version  );
    wp_enqueue_script( 'singular_respond', THEME_DIRECTORY_URI.'/assets/js/respond.min.js', array(), $version );
    wp_enqueue_script( 'singular_plugins', THEME_DIRECTORY_URI.'/assets/js/plugins.js', array(), $version  );
    wp_enqueue_script( 'singular_scripts', THEME_DIRECTORY_URI.'/assets/js/scripts.js', array(), $version);
}
